...
class TestController extends Controller
{
     ...
     * @Route("/t", name="t")
     */
    public function data_trasn(WinterJobsRepository $winterJobsRepository, WinterJobUniqueRepository $winterJobUniqueRepository)
    {
        ...
        foreach ($winterJobsRepository->findAll() as $winterJob)
        {
            foreach ($winterJob->getRoadSections() as $roadSection)
            {
                ...
                if($this->validate($winterJob,$roadSection)) {
    ...
    function validate($winterJob, $roadSection)
    {
